...
\vspace{16pt}
```{r, echo=FALSE, fig.height=5, fig.width=9.5, fig.align='center', warning=FALSE, message=FALSE}
...
```{r, echo=FALSE, fig.height=4, fig.width=9, fig.align='center', warning=FALSE, message=FALSE}
dl$corrType <- "Same"
