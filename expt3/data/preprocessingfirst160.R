...
# since we preregistered 80 per condition, limit dataset to just first 160
fullD <- fullD[1:160,]
...
save(orig,fullD,ds,dl,sl,pf,nBad,nPFoutChinese,nPFoutUnfamiliar,file="alldata160.RData")
write.csv(ds,'shortdata160.csv')
write.csv(dl,'longdata160.csv')